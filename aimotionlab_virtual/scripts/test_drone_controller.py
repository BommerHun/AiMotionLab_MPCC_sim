...
from aimotionlab_virtual.classes.drone import Drone, DRONE_TYPES
from aimotionlab_virtual.classes.payload import Payload
...
from aimotionlab_virtual.classes.drone_classes.hooked_drone_lq_control import LtvLqrLoadControl
import numpy as np
