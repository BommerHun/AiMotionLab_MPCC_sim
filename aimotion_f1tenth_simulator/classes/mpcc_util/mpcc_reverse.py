...
class mpcc_reverse_controller(ControllerBase):
    """
    ...
    def _cost_expr(self, point, thetahat, thetahatdot, ddot, deltadot):
        ...
        :param point: array containg x and y coordinates
        :param thetahat: virtual path parameter
        :param thetahatdot: change of the virtual path parameter
        :param ddot: change of the motor reference
        :param deltadot: change of the steering reference
        :return: cost
        """
    ...
    def _cost_e_l_c(self, point, theta):
        ...
        :return: np.array([long_error, con_error])
        """
