...
car0.set_drivetrain_parameters(C_m1=40, C_m2=2, C_m3=0.5) # if not specified the default values will be used 
...
car0_trajectory.build_from_points_const_speed(path_points=path_points, path_smoothing=0.01, path_degree=4, const_speed=1.2)
car0_trajectory.plot_trajectory() # this is a blocking method close the plot to proceed


car0_controller = CarLPVController(car0.mass, car0.inertia) # init controller
